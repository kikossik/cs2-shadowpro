...
from .vectorize import feature_blob_to_vector
...
def list_match_anchor_specs(
    *,
    ...
    """Return reusable anchor specs for a parsed match parquet set."""
    return _iter_anchor_specs(
        ticks=frames["ticks"],
    ...
    *,
    ...
    for anchor in anchors:
        ...
        windows.append({
            ...
            "feature_path": to_managed_path(feature_path),
            "embedding": feature_blob_to_vector(features),
        })
